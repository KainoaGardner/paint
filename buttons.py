...
smallButton = Buttons("1",30,MARGINSIZE + TILESIZE * 60,MARGINSIZE + TILESIZE * 100,TILESIZE *10,TILESIZE * 5,WHITE)
midButton = Buttons("2",30,MARGINSIZE + TILESIZE * 60,MARGINSIZE + TILESIZE * 105,TILESIZE *10,TILESIZE * 5,WHITE)
bigmidButton = Buttons("3",30,MARGINSIZE + TILESIZE * 60,MARGINSIZE + TILESIZE * 110,TILESIZE *10,TILESIZE * 5,WHITE)
bigButton = Buttons("4",30,MARGINSIZE + TILESIZE * 60,MARGINSIZE + TILESIZE * 115,TILESIZE *10,TILESIZE * 5,WHITE)

fill = Buttons("fill",20,MARGINSIZE + TILESIZE * 70,MARGINSIZE + TILESIZE * 100,TILESIZE *10,TILESIZE * 10,WHITE)
clear = Buttons("clear",20,MARGINSIZE + TILESIZE * 70,MARGINSIZE + TILESIZE * 110,TILESIZE *10,TILESIZE * 10,WHITE)
save = Buttons("save",30,MARGINSIZE + TILESIZE * 80,MARGINSIZE + TILESIZE * 100,TILESIZE *20,TILESIZE * 10,WHITE)
saveImg = Buttons("save Img",30,MARGINSIZE + TILESIZE * 80,MARGINSIZE + TILESIZE * 110,TILESIZE *20,TILESIZE * 10,WHITE)
...
buttonList = [fill,clear,save,saveImg]
